...
def autoupload_image():
    try:
        ...
        if file.filename != '':
            ...
            model_path = r'C:\Users\Ahsan ikram\PycharmProjects\TrafficGuardian\yolov8mtrafficmodel.pt'
            model_pathr= r'C:\Users\Ahsan ikram\PycharmProjects\TrafficGuardian\yolov8s.pt'
...
def upload_image():
    try:
        ...
        if file.filename != '':
            ...
            file_path = os.path.join(app.config['UPLOAD_FOLDER'], file.filename)
            image.save(file_path)
            model_path = r'C:\Users\Ahsan ikram\PycharmProjects\TrafficGuardian\yolov8s.pt'
            preprocessed_image=YoloController.preprocess_image(image)
            print("Preprocessed image shape:", preprocessed_image.shape)
